...
gt_data = pd.read_csv("result/sim_easy/gt.csv")
dr_data = pd.read_csv("result/sim_easy/dr.csv")
opt_data = pd.read_csv("result/sim_easy/opt.csv")
em_data = pd.read_csv("result/sim_easy/em.csv")
boem_data = pd.read_csv("result/sim_easy/boem.csv")
